...
#ifndef DEPTH_IMAGE_FILTERS_MEDIAN_FILTER_HPP
#define DEPTH_IMAGE_FILTERS_MEDIAN_FILTER_HPP

#include "depth_image_filters/filters/depth_filter_base.hpp"

namespace depth_image_filters {
class MedianFilter : public DepthFilterBase {
public:
...
#endif // DEPTH_IMAGE_FILTERS_MEDIAN_FILTER_HPP
